...
const StatCard = ({ label, value, subtext, color, highlight = false }) => {
  return (
    <div
    ...
    >
      <div className="flex items-center gap-3">
        <div
          ...
          style={{ backgroundColor: scenarioInfo.color }}
        />
        <div>
        ...
        <div className="mt-4 p-4 bg-green-50 rounded-lg border border-green-200">
          ...
          <p className="text-sm text-green-700">
            ...
            <span className="font-bold">
              {formatCurrency(summary.cumulativeHouseholdCosts.unoptimized - summary.cumulativeHouseholdCosts.dispatchable)}
            </span>{' '}
            over {projectionYears} years if the utility and regulators require flexible operations with dispatchable generation instead of allowing unoptimized firm load.
          </p>
        </div>
      </div>
    </div>
