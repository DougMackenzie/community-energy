 ...
 *
 * Main visualization showing the 4 cost trajectories over time.
...
// Legend with scenario descriptions
const ScenarioLegend = ({ selectedScenarios, onToggle }) => {
  return (
    ...
    <div className="w-full">
      <ResponsiveContainer width="100%" height={height}>
        ...
        >
          ...
          {/* Reference line for current bill */}
          <ReferenceLine
